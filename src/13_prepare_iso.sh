...
prepare_boot_bios() {
  ...
  # UEFI error message.
  cp -r $SRC_DIR/moneros_boot/bios/* \
    $ISOIMAGE
...
prepare_boot_uefi() {
  ...
  image_size=$((kernel_size + rootfs_size + loader_size + 65536*2))
...
#  cp -r $SRC_DIR/moneros_boot/uefi/* \
#    $ISOIMAGE
  ...
  cp $SRC_DIR/moneros_boot/uefi/loader/loader.conf \
    $WORK_DIR/uefi/loader
  cp $SRC_DIR/moneros_boot/uefi/loader/entries/mll-${MLL_CONF}.conf \
